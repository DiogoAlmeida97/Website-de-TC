...
def Entrada():
    ...
    return render_template("Entrada.html",posts=posts)
...
def account():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('A sua conta foi actualizada!', 'success')
...
def new_post():
    ...
    if form.validate_on_submit():
        ...
        return redirect(url_for('Entrada'))
    return render_template('create_post.html', title='Criar Post',
                           form=form, legend='Criar Post')
...
def update_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('O seu post foi actualizado!', 'success')
